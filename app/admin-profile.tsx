...
export default function AdminProfile() {
  ...
  const profileOptions = [
    ...
    { id: '3', icon: 'bookmark-outline', title: 'Saved Notices', route: '/student-bookmarks' }, // You can change this route if admin has a different saved notices page
  ];
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => router.push('/admin-categories')}>
